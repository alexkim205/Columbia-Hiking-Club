...
from blog.views import HikesListAPI, HikeAPI, HikeRequestsListAPI, HikeRequestAPI
...
urlpatterns = [
    ...
    path('hike-request/<int:pk>', HikeRequestAPI.as_view(), name='hike_request_api'),
    # path('hike-request/form', HikeRequestFormAPI.as_view(), name='hike_request_form_api'),
