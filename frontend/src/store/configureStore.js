...
// 'routerMiddleware': the new way of storing route changes with redux
// middleware since rrV4.
...
function configureStoreProd (initialState) {
  ...
  const middlewares = [
    ...
    // thunk middleware can also accept an extra argument to be passed to each
    // thunk action
